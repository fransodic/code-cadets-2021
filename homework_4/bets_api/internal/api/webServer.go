...
const betByStatusPath = "/bets"
const betByCustomerIdPath = "/user/:id/bets"
...
func (w *WebServer) registerRoutes(ctrl Controller) {
	...
	w.router.GET(betByStatusPath, ctrl.GetBetsByStatus())
	w.router.GET(betByCustomerIdPath, ctrl.GetBetsByCustomerID())
}
